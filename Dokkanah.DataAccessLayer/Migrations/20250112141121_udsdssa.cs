...
{
    /// <inheritdoc />
    public partial class udsdssa : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isAgree = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Custid = table.Column<int>(type: "integer", nullable: true),
                    Name = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Caid = table.Column<int>(type: "integer", nullable: false),
                    Prid = table.Column<int>(type: "integer", nullable: false),
                    ProductItemsNumbers = table.Column<int>(type: "integer", nullable: true),
                    NumberConstant = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
